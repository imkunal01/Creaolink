# Introduction
Start by saying a simple `Congratulations! You just created your first plugin` within a UXP plugin or use this as a template to add your code. This plugin has a very basic setup for you to create a `command` and a `panel` within a UXP plugin. 

## Compatibility
Since PremierePro v26.5.
